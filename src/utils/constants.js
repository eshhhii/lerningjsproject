...
export const userInfoPopupSelector = ".popup_edit";
export const newCardPopupSelector = ".popup_add";
export const popupImageSelector = ".popup_images";
...
export const showDeleteCardPopup = document.querySelector(".element__bin");
